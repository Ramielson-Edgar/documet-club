            ...
            for (u = a.callFilters('commandsHandleClick', u, arguments), a.pending = a.bound.length, f = 0; (o = a.bound[f]); f++)
               (l = u[f]),
                  l &&
                     ...
                     ('function' == typeof o.config.callbacks.onMixClick && ((s = o.config.callbacks.onMixClick.call(o.lastClicked, o.state, t, o)), s === !1)) || ('toggle' === a.type ? (r ? o.toggleOff(l.filter) : o.toggleOn(l.filter)) : o.multimix(l)));
      ...
      n.extend(e.Mixer.prototype, {
         ...
         attach: function (a, i, o, r) {
            var s = this,
               ...
               c = -1;
            for (
               s.callActions('beforeAttach', arguments), s.id = o, r && n.extend(s.config, r, !0, !0), s.sanitizeConfig(), s.cacheDom(a, i), s.config.layout.containerClassName && n.addClass(s.dom.container, s.config.layout.containerClassName), e.features.has.transitions || (s.config.animation.enable = !1), 'undefined' == typeof t.console && (s.config.debug.showWarnings = !1), s.config.data.uidKey && (s.config.controls.enable = !1), s.indexTargets(), s.state = s.getInitialState(), c = 0;
         ...
         getNextSibling: function (t, e, n) {
            ...
            return (
               ...
               e && 'before' === n
                  ...
                  : 0 === a.targets.length && a.dom.parent.children.length > 0 && (a.config.layout.siblingAfter ? (i = a.config.layout.siblingAfter) : a.config.layout.siblingBefore ? (i = a.config.layout.siblingBefore.nextElementSibling) : a.dom.parent.children[0]),
         ...
         getTweenData: function (t) {
            ...
            for (n.callActions('beforeGetTweenData', arguments), u = 0; (a = t.show[u]); u++)
               for (
                  ...
                  (s = n.effectsIn[r]), s instanceof e.TransformData && s.value && ((i.posIn[r].value = s.value), (i.posOut[r].value = 0), (i.tweenData[r].value = i.posOut[r].value - i.posIn[r].value), (i.posIn[r].unit = i.posOut[r].unit = i.tweenData[r].unit = s.unit));
            for (u = 0; (a = t.toHide[u]); u++)
               for (
                  i = t.toHidePosData[u],
                     ...
                     i.tweenData.x = i.posOut.x - i.posIn.x,
                     i.tweenData.y = i.posOut.y - i.posIn.y,
                     n.config.animation.animateResizeTargets && ((i.posIn.width = i.startPosData.width), (i.posIn.height = i.startPosData.height), (l = i.startPosData.width - i.interPosData.width), (i.posIn.marginRight = i.startPosData.marginRight - l), (c = i.startPosData.height - i.interPosData.height), (i.posIn.marginBottom = i.startPosData.marginBottom - c)),
                     i.posIn.opacity = 1,
                  ...
                  (s = n.effectsOut[r]), s instanceof e.TransformData && s.value && ((i.posIn[r].value = 0), (i.posOut[r].value = s.value), (i.tweenData[r].value = i.posOut[r].value - i.posIn[r].value), (i.posIn[r].unit = i.posOut[r].unit = i.tweenData[r].unit = s.unit));
         ...
         cleanUp: function (t) {
            ...
            t.willSort && (a.targets = t.newOrder),
               ...
               t.hasFailed && (e.events.fire('mixFail', a.dom.container, { state: a.state, instance: a }, a.dom.document), 'function' == typeof a.config.callbacks.onMixFail && a.config.callbacks.onMixFail.call(a.dom.container, a.state, a), n.addClass(a.dom.container, n.getClassname(a.config.classNames, 'container', a.config.classNames.modifierFailed))),
         ...
         queueMix: function (t) {
            ...
            return (
               ...
               a.config.animation.queue && a.queue.length < a.config.animation.queueLimit
                  ? ((t.deferred = i), a.queue.push(t), a.config.controls.enable && (a.isToggling ? (a.buildToggleArray(t.instruction.command), (o = a.getToggleSelector()), a.updateControls({ filter: { selector: o } })) : a.updateControls(t.instruction.command)))
                  : (a.config.debug.showWarnings && console.warn(e.messages.warningMultimixInstanceQueueFull()), i.resolve(a.state), e.events.fire('mixBusy', a.dom.container, { state: a.state, instance: a }, a.dom.document), 'function' == typeof a.config.callbacks.onMixBusy && a.config.callbacks.onMixBusy.call(a.dom.container, a.state, a)),
            ...
            return (
               ...
               a.isBusy
                  ...
                  : (l && a.insertTargets(l, c),
                    ...
                    a.config.animation.enable && (a.getStartMixData(c), a.setInter(c), (c.docState = n.getDocumentState(a.dom.document)), a.getInterMixData(c), a.setFinal(c), a.getFinalMixData(c), a.parseEffects(), (c.hasEffect = a.hasEffect()), a.getTweenData(c)),
      ...
      n.extend(e.Target.prototype, {
         ...
         applyStylesOut: function (t) {
            ...
            switch (
               ...
               (n.isBound = !0),
               n.applyTransition(a),
               o && t.posOut.width > 0 && t.posOut.height > 0 && ((n.dom.el.style.width = t.posOut.width + 'px'), (n.dom.el.style.height = t.posOut.height + 'px'), (n.dom.el.style.marginRight = t.posOut.marginRight + 'px'), (n.dom.el.style.marginBottom = t.posOut.marginBottom + 'px')),
